...
CREATE TABLE `usergroupmap` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK67xl9ecetfu2lxupgqypopwrp` (`group_id`),
  KEY `FK5wkdf3lesqtfrl52tsykm6ddu` (`user_id`),
  CONSTRAINT `FK5wkdf3lesqtfrl52tsykm6ddu` FOREIGN KEY (`user_id`) REFERENCES `user` (`uid`),
  CONSTRAINT `FK67xl9ecetfu2lxupgqypopwrp` FOREIGN KEY (`group_id`) REFERENCES `usersgroup` (`id`)
...
-- Dump completed on 2022-10-01 22:09:48
